...
Обновление: исправление закоммичено и отправлено в remote, MPOD-REL-02 закрыта; итоговый APK и evidence — `mpoddy-release-1.0.18-closure.md`. Ниже сохранено состояние на момент технического прогона.
